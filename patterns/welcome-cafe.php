...
<h3 class="wp-block-heading has-text-align-left is-style-pato-script has-x-large-font-size">Since 2011</h3>
<!-- /wp:heading -->

<!-- wp:heading {"fontSize":"heading"} -->
<h2 class="wp-block-heading has-heading-font-size">The corner everyone claims</h2>
<!-- /wp:heading -->
