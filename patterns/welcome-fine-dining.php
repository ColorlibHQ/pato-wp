<?php
/**
 * Title: Welcome: Fine dining
 * Slug: pato/welcome-fine-dining
 * Categories: pato-sections
 * Keywords: about, fine-dining
 * Description: The fine dining starter's introduction.
 * Viewport Width: 1400
 *
 * @package Pato
 */
...
<figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/chef-flambe.avif' ) ); ?>" alt="A chef cooking over a flaring pan" style="border-radius:6px;aspect-ratio:4/5;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-text-align-left is-style-pato-script has-x-large-font-size">The kitchen</h3>
<!-- /wp:heading -->

<!-- wp:heading {"fontSize":"heading"} -->
<h2 class="wp-block-heading has-heading-font-size">One menu, written each morning</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>There is no choosing. What arrives at the door before eight decides what is served after seven, and the eight courses are built around it that day.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Twenty-four seats, one sitting, and a pass you can watch from every table in the room.</p>
<!-- /wp:paragraph -->
