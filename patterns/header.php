...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:22%"><!-- wp:buttons {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","justifyContent":"right"}} -->
