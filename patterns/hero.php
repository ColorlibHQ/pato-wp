...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-colossal-font-size">A table by the fire</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}},"textColor":"base","fontSize":"large"} -->
<p class="has-text-align-center has-base-color has-text-color has-large-font-size">Seasonal plates, an open kitchen and a short, careful wine list — in the middle of the city since 1998.</p>
<!-- /wp:paragraph -->
