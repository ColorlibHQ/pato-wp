...
/**
 * Title: Search banner
 * Slug: pato/hidden-search-banner
 * Inserter: no
 *
 * @package Pato
 */
...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/banner-contact.avif' ) ); ?>","dimRatio":60,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":340,"align":"full","className":"pato-banner","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:query-title {"type":"search","className":"pato-banner__title","style":{"typography":{"textAlign":"center"}},"textColor":"overlay"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
