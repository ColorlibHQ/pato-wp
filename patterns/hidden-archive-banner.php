...
<div class="wp-block-group"><!-- wp:query-title {"type":"archive","className":"pato-banner__title","style":{"typography":{"textAlign":"center"}},"textColor":"overlay"} /-->

<!-- wp:term-description {"style":{"typography":{"textAlign":"center"}},"textColor":"overlay"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
