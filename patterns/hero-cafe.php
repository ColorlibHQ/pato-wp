...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/dish-baked-apple.avif' ) ); ?>","dimRatio":62,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":600,"align":"full","className":"pato-banner","layout":{"type":"constrained"}} -->
...
<h3 class="wp-block-heading has-text-align-center is-style-pato-script has-overlay-color has-text-color has-x-large-font-size">All day</h3>
<!-- /wp:heading -->

<!-- wp:heading {"level":1,"style":{"typography":{"textAlign":"center"}},"textColor":"overlay","fontSize":"colossal"} -->
<h1 class="wp-block-heading has-text-align-center has-overlay-color has-text-color has-colossal-font-size">Coffee, cake and a quiet corner</h1>
<!-- /wp:heading -->
