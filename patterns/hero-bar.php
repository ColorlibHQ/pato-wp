...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/drink-cocktail.avif' ) ); ?>","dimRatio":62,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","align":"full","className":"pato-banner pato-hero","layout":{"type":"constrained"}} -->
...
<h3 class="wp-block-heading has-text-align-center is-style-pato-script pato-hero__eyebrow has-overlay-color has-text-color">Cocktails &amp; small plates</h3>
<!-- /wp:heading -->

<!-- wp:heading {"level":1,"className":"pato-hero__title","style":{"typography":{"textAlign":"center"}},"textColor":"overlay"} -->
<h1 class="wp-block-heading has-text-align-center pato-hero__title has-overlay-color has-text-color">Open until late</h1>
<!-- /wp:heading -->
