...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-dining.avif' ) ); ?>","dimRatio":62,"overlayColor":"dark","isUserOverlayColor":true,"minHeight":600,"align":"full","className":"pato-banner","layout":{"type":"constrained"}} -->
...
<h3 class="wp-block-heading has-text-align-center is-style-pato-script has-overlay-color has-text-color has-x-large-font-size">Neighbourhood bistro</h3>
<!-- /wp:heading -->
