...
<div class="wp-block-group alignfull" id="map" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","contentSize":"720px"}} -->
...
<h3 class="wp-block-heading has-text-align-center is-style-pato-script has-x-large-font-size">How to find us</h3>
<!-- /wp:heading -->

<!-- wp:heading {"style":{"typography":{"textAlign":"center"}},"fontSize":"heading"} -->
<h2 class="wp-block-heading has-text-align-center has-heading-font-size">On the map</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
