...
= 1.1.1 =
* Fixed: pages built on activation or by a starter site opened in the editor with "unexpected or invalid content" on every spacer. Existing pages are repaired on update.

= 1.1.0 =
* Each starter site now has its own menu, offers and gallery rather than sharing one set.
* 20 more photographs; alt text corrected throughout.
