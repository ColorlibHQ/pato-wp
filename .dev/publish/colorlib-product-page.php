...
$content = <<<HTML
[vc_row css=".vc_custom_pato001{padding-top:64px !important;padding-bottom:40px !important;background-color:#faf7f4 !important;}"][vc_column width="1/1"][vcex_heading text="A restaurant theme that already knows what a restaurant needs" tag="h2" font_size="46px" text_align="center" bottom_margin="20px" font_weight="700"][vc_column_text css=".vc_custom_pato002{text-align:center !important;font-size:18px !important;max-width:820px !important;margin-left:auto !important;margin-right:auto !important;}"]Pato is a free block theme for restaurants, bistros, cafés and bars. It ships the two things every restaurant site needs and normally has to buy a plugin for — a menu with prices and a booking form — plus six one-click starter sites, eight colour palettes and full site editing throughout.[/vc_column_text][vc_column_text css=".vc_custom_pato003{text-align:center !important;margin-top:26px !important;}"][vc_btn title="Download Pato" style="flat" color="green" link="url:{$download_enc}|title:Download%20Pato|target:_blank" css=".vc_custom_pato004{{$btn_css}}" i_icon_fontawesome="fa fa-download" add_icon="true"][vc_btn title="Live demo" style="flat" color="grey" link="url:{$demo_enc}|title:Live%20demo|target:_blank" css=".vc_custom_pato005{{$btn_css}}" i_icon_fontawesome="fa fa-eye" add_icon="true"][/vc_column_text][/vc_column][/vc_row][vc_row css=".vc_custom_pato006{padding-top:0px !important;padding-bottom:64px !important;background-color:#faf7f4 !important;}"][vc_column width="1/1"][vcex_image image_id="{$img_home}" align="center" border_radius="14px" bottom_margin="0px"][/vc_column][/vc_row]
...
[vc_row css=".vc_custom_pato030{padding-top:56px !important;padding-bottom:20px !important;}"][vc_column width="1/1"][vcex_heading text="Six restaurants, one theme" tag="h2" font_size="34px" text_align="center" bottom_margin="14px" font_weight="700"][vc_column_text css=".vc_custom_pato031{text-align:center !important;max-width:800px !important;margin-left:auto !important;margin-right:auto !important;}"]A bar’s first screen asks for a table at eleven at night; a bakery’s says what came out of the oven. Pato ships six starter sites — bistro, fine dining, café, pizzeria, bar and bakery — each with its own opening screen, its own copy and its own palette and type pairing. Importing one builds a front page you can edit like any other page, and it never touches a page you already have.[/vc_column_text][/vc_column][/vc_row][vc_row css=".vc_custom_pato032{padding-bottom:56px !important;}"][vc_column width="1/1"][vcex_image image_id="{$img_palettes}" align="center" border_radius="12px" bottom_margin="0px"][/vc_column][/vc_row]
...
foreach ( array( $download, $demo ) as $target ) {
...
echo 'images resolve: ';
foreach ( array( $img_home, $img_menu, $img_reservation, $img_palettes, $img_dark, $img_blog, $img_card ) as $id ) {
