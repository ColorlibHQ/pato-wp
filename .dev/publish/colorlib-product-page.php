...
$content = <<<HTML
[vc_row css=".vc_custom_pato001{padding-top:64px !important;padding-bottom:40px !important;background-color:#faf7f4 !important;}"][vc_column width="1/1"][vcex_heading text="A restaurant theme that already knows what a restaurant needs" tag="h2" font_size="46px" text_align="center" bottom_margin="20px" font_weight="700"][vc_column_text css=".vc_custom_pato002{text-align:center !important;font-size:18px !important;max-width:820px !important;margin-left:auto !important;margin-right:auto !important;}"]Pato is a free block theme for restaurants, bistros, cafés and bars. It ships the two things every restaurant site needs and normally has to buy a plugin for — a menu with prices and a booking form — plus six one-click starter sites, eight colour palettes and full site editing throughout.[/vc_column_text][vc_column_text css=".vc_custom_pato003{text-align:center !important;margin-top:26px !important;}"][vc_btn title="Download Pato" style="flat" color="green" link="url:{$download_enc}|title:Download%20Pato|target:_blank" css=".vc_custom_pato004{{$btn_css}}" i_icon_fontawesome="fa-solid fa-download" add_icon="true"][vc_btn title="Live demo" style="flat" color="grey" link="url:{$demo_enc}|title:Live%20demo|target:_blank" css=".vc_custom_pato005{{$btn_css}}" i_icon_fontawesome="fa-regular fa-eye" add_icon="true"][vc_btn title="Documentation" style="flat" color="grey" link="url:{$docs_enc}|title:Documentation" css=".vc_custom_pato005b{{$btn_css}}" i_icon_fontawesome="fa-solid fa-book" add_icon="true"][/vc_column_text][/vc_column][/vc_row][vc_row css=".vc_custom_pato006{padding-top:0px !important;padding-bottom:64px !important;background-color:#faf7f4 !important;}"][vc_column width="1/1"][vcex_image image_id="{$img_home}" align="center" border_radius="14px" bottom_margin="0px"][/vc_column][/vc_row]
