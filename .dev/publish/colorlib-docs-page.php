...
$content = '[vc_row el_id="top" css=".vc_custom_patodoc00{padding-top:44px !important;padding-bottom:30px !important;background-color:#faf7f4 !important;}"][vc_column width="1/1"]'
	...
	. '[vc_btn title="Download Pato" style="flat" color="green" link="url:' . $download_enc . '|title:Download%20Pato|target:_blank" css=".vc_custom_patodoc00c{' . $btn_css . '}" i_icon_fontawesome="fa-solid fa-download" add_icon="true"]'
	. '[vc_btn title="Live demo" style="flat" color="grey" link="url:' . $demo_enc . '|title:Live%20demo|target:_blank" css=".vc_custom_patodoc00d{' . $btn_css . '}" i_icon_fontawesome="fa-regular fa-eye" add_icon="true"]'
	. '[/vc_column_text]'
